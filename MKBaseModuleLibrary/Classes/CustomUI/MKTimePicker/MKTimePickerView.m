...
- (UIDatePicker *)datePicker{
    if (!_datePicker) {
        ...
        _datePicker.frame = CGRectMake(10, kDatePickerH - 216, self.frame.size.width - 2 * 10, 216);
        ...
        _datePicker.backgroundColor = RGBCOLOR(239, 239, 239);
